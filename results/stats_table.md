...
| ('boiler_drift', 'hama')       |   5 |    0.5378 |   0.0377 |      0.4393 |     0.0832 |     0.7367 |    0.1231 |     0.733  |    0.0123 |     0.047  |   0.7798 |
...
| ('boiler_static', 'hama')      |   5 |    0.5207 |   0.0595 |      0.4448 |     0.0332 |     0.6494 |    0.1493 |     0.6504 |    0.0251 |     0      |   2.0334 |
...
| ('wind_static', 'hama')        |   5 |    0.0682 |   0.0172 |      0.0596 |     0.0308 |     0.306  |    0.2489 |     0.5264 |    0.004  |     0      |   1.4999 |

## Welch t-tests on seed-level F1 (HAMA vs baselines)

| Dataset | Comparison | ΔF1 | t | p | Cohen's d | Significant (α=0.05) |
|---|---|---|---|---|---|---|
| boiler_drift | HAMA vs baseline1 | +0.0059 | 0.33 | 0.7519 | 0.21 | no |
| boiler_drift | HAMA vs baseline2 | -0.0086 | -0.48 | 0.6536 | -0.30 | no |
| boiler_static | HAMA vs baseline1 | -0.0160 | -0.57 | 0.5926 | -0.36 | no |
| boiler_static | HAMA vs baseline2 | -0.0160 | -0.57 | 0.5926 | -0.36 | no |
| wind_static | HAMA vs baseline1 | +0.0043 | 0.55 | 0.6088 | 0.35 | no |
| wind_static | HAMA vs baseline2 | +0.0043 | 0.55 | 0.6088 | 0.35 | no |

## Drift-mode per-segment F1 (mean over seeds)

* baseline1: 0.502 -> 0.567 -> 0.526
* baseline2: 0.502 -> 0.585 -> 0.555
* hama: 0.495 -> 0.579 -> 0.542
